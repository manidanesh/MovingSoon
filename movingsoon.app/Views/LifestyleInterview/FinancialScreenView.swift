...
// MARK: - Institution Picker Grid
// Reusable search + type-tabs + grid content, with no dependency on the full-screen
// InterviewScreenView chrome (back arrow, floating Continue pill) so it can also be
